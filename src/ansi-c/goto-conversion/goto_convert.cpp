...
void goto_convertt::optimize_guarded_gotos(goto_programt &dest)
{
  ...
  for(auto it = dest.instructions.begin(); it != dest.instructions.end(); it++)
  {
    ...
    if(
      ...
      it_goto_y->condition() != true || it_goto_y->is_target())
    {
      continue;
    }
  ...
  const irep_idt &mode)
{
  ...
  if(
    ...
    dest.instructions.back().condition() == true)
  {
  ...
  const irep_idt &mode)
{
  ...
  if(
    ...
    true_case.instructions.back().condition() == false &&
  ...
  if(
    ...
    false_case.instructions.back().condition() == false &&
  ...
  if(
    ...
    simplify_expr(true_case.instructions.front().condition(), ns) == false &&
