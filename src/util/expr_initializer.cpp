  ...
  const exprt &init_expr)
{
  ...
  else if(type_id==ID_array)
  {
    ...
    {
      auto tmpval = expr_initializer_rec(array_type.subtype(), source_location, init_expr);
      if(!tmpval.has_value())
        return {};
  ...
  else if(type_id==ID_vector)
  {
    ...
    auto tmpval = expr_initializer_rec(vector_type.subtype(), source_location, init_expr);
    if(!tmpval.has_value())
      return {};
