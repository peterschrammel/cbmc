...
int main()
{
  ...
  //assert(__CPROVER_get_field(s.x[0].x2, "field1") == 0);
  ...
  //assert(__CPROVER_get_field(s.x[2].x2, "field1") == 0);
  ...
  __CPROVER_set_field(&(s.y), "field1", 2);
  assert(__CPROVER_get_field(&s, "field1") == 3);
  assert(__CPROVER_get_field(&(s.x[0]), "field1") == 1);
  assert(__CPROVER_get_field(&(s.x[0].x1), "field1") == 1);
  //assert(__CPROVER_get_field(s.x[0].x2, "field1") == 0);
  assert(__CPROVER_get_field(&(s.x[0].x2[0]), "field1") == 0);
  ...
  assert(__CPROVER_get_field(&(s.x[2].x2[0]), "field1") == 0);
  assert(__CPROVER_get_field(&(s.x[2].x2[1]), "field1") == 0);
  assert(__CPROVER_get_field(&(s.y), "field1") == 2);

  __CPROVER_set_field(&(s.x[1].x2[0]), "field1", 4);
  assert(__CPROVER_get_field(&s, "field1") == 7);
  assert(__CPROVER_get_field(&(s.x[0]), "field1") == 1);
  assert(__CPROVER_get_field(&(s.x[0].x1), "field1") == 1);
  //assert(__CPROVER_get_field(s.x[0].x2, "field1") == 0);
  assert(__CPROVER_get_field(&(s.x[0].x2[0]), "field1") == 0);
  assert(__CPROVER_get_field(&(s.x[0].x2[1]), "field1") == 0);
  assert(__CPROVER_get_field(&(s.x[1].x1), "field1") == 0);
  //assert(__CPROVER_get_field(s.x[1].x2, "field1") == 4);
  assert(__CPROVER_get_field(&(s.x[1].x2[0]), "field1") == 4);
  assert(__CPROVER_get_field(&(s.x[1].x2[1]), "field1") == 0);
  assert(__CPROVER_get_field(&(s.x[2].x1), "field1") == 0);
  //assert(__CPROVER_get_field(s.x[2].x2, "field1") == 0);
  assert(__CPROVER_get_field(&(s.x[2].x2[0]), "field1") == 0);
  ...
  __CPROVER_set_field(&(s.x[2].x2[1]), "field1", 8);
  assert(__CPROVER_get_field(&s, "field1") == 15);
  assert(__CPROVER_get_field(&(s.x[0]), "field1") == 1);
  assert(__CPROVER_get_field(&(s.x[0].x1), "field1") == 1);
  //assert(__CPROVER_get_field(s.x[0].x2, "field1") == 0);
  assert(__CPROVER_get_field(&(s.x[0].x2[0]), "field1") == 0);
  ...
  assert(__CPROVER_get_field(&(s.x[1].x2[1]), "field1") == 0);
  assert(__CPROVER_get_field(&(s.x[2].x1), "field1") == 0);
  //assert(__CPROVER_get_field(s.x[2].x2, "field1") == 8);
  assert(__CPROVER_get_field(&(s.x[2].x2[0]), "field1") == 0);
  assert(__CPROVER_get_field(&(s.x[2].x2[1]), "field1") == 8);
  assert(__CPROVER_get_field(&(s.y), "field1") == 2);
}
